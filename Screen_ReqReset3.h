#ifndef  SCREEN_REQRESET3_H
#define  SCREEN_REQRESET3_H
 ...
 * \addtogroup Screens
 * \{
 * \brief   Public interface for Request Reset Screen template (image #3)
 *
