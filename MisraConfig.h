#ifndef MISRACONFIG_H
#define MISRACONFIG_H
 ...
 * \addtogroup Include
 * \{
 * \brief   Configuration defined for disabling Misra Checks.
 *
 * \details This file has the configuration required to enable/disable Misra checks. 
 * 
