#ifndef  SCREEN_REQRESET2_H
#define  SCREEN_REQRESET2_H
 ...
 * \addtogroup Screens
 * \{
 * \brief   Public interface for Request Reset Screen template (image #2)
 *
