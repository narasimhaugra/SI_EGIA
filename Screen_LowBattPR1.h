#ifndef  SCREEN_LOWBATTPR1_H
#define  SCREEN_LOWBATTPR1_H
 ...
 * \addtogroup Screens
 * \{
 * \brief   Public interface for Low Battery Screen (image #1)
 *
