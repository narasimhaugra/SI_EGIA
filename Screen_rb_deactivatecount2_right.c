 ...
 *
 * \file    Screen_rb_deactivatecount2_right.c
 *
 * ========================================================================== */
/******************************************************************************/
/*                             Include                                        */
...
/* ==========================================================================*/
 /**
 *
 * \brief   Set ROTATE_DEACT_RIGHT_C2_SCREEN. Rotation Buttons Deactivate Countdown2 Right
 *
 * \details This function Set the Rotation Buttons Deactivate Countdown2 Right screen.
 *
 * \param   < None >
 *
 * \return  None
 *
* ==========================================================================*/
void Gui_RotateDeactRightCount2_ScreenSet( void )
{
  if(UI_ReturnToDefaultParameters())
  {
   ...
   L4_DmShowScreen_New(SCREEN_ID_RB_DEACTIVATION_COUNT2_RIGHT,
