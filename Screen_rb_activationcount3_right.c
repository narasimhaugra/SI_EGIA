 ...
 *
 * \file    Screen_rb_activationcount3_right.c
 *
 * ========================================================================== */
/******************************************************************************/
/*                             Include                                        */
...
/* ==========================================================================*/
 /**
 *
 * \brief   Set ROTATE_ACTIVATE_RIGHT_C3_SCREEN. Rotation Button Activation Countdown3 Right 
 *
 * \details This function Set the Rotation Button Activation Countdown3 Right screen.
 *
 * \param   < None >
 *
 * \return  None
 *
* ==========================================================================*/
void Gui_RotateActivateRightCount3_ScreenSet( void )
{
  if(UI_ReturnToDefaultParameters())
  {
   ...
   L4_DmShowScreen_New(SCREEN_ID_RB_ACTIVATION_COUNT3_RIGHT,
