#ifndef  SCREEN_REQRESET6_H
#define  SCREEN_REQRESET6_H
 ...
 * \addtogroup Screens
 * \{
 * \brief   Public interface for Request Reset Screen template (image #6)
 *
